...
Input animations for the Dashboard are produced in a [Notebook](https://github.com/digitalearthafrica/deafrica-direct-access/blob/nrt/Use_cases/NorthernRangelandsTrust/NorthernRangelandsTrust.ipynb/0 in the deafrica-direct-access repository.
